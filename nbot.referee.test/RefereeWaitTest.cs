...
namespace nbot.referee.test
{
    ...
    /// run on my system it goes out of scale average 60 times. Where for out of scale 
    /// I mean the actual wait is longer or shorter more than 10% of the predefined 
    /// timeout. The second is using ManualResetEvent this works better and goes 
    /// out of scale average 30 times.
    /// The third solution just do a spin, which is very expensive on the CPU but
    /// never goes out of scale.
    /// </summary>
    public class RefereeWaitTest
    {
